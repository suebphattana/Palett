...
interface ImageToVideoModelSelectorProps {
...
export function ImageToVideoModelSelector({ selectedModel, onModelSelect }: ImageToVideoModelSelectorProps) {
  const [isOpen, setIsOpen] = useState(false)
  
  const selectedConfig = selectedModel ? IMAGE_TO_VIDEO_MODELS[selectedModel as keyof typeof IMAGE_TO_VIDEO_MODELS] : null
    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-muted-foreground">Choose your image-to-video model</p>
        </div>
      ...
      <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DropdownMenuContent className="w-[400px] p-2" align="start">
          {Object.entries(IMAGE_TO_VIDEO_MODELS).map(([key, config]) => {
